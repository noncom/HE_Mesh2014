...
public class WB_RenderJME {
    JmeMeshRenderer home;
...
//    }
	...
	home.rotate(angles.xf(), angles.yf(), angles.zf());
...
//	    System.out.println("R_JME drawFaces [B] =" + fItr.hasNext());
	...
	public void captureViewMatrix(final JmeMeshRenderer home) {
	...
	unproject.calculatePickPoints(x, y, home.getHeight());
